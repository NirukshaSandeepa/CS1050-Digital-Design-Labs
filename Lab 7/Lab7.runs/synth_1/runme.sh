...
HD_PWD='D:/Academic/Computer Organization and Digital Design/Labs/Lab7/Lab7/Lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AU_7_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AU_7_seg.tcl
