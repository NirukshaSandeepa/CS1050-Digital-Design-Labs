...
HD_PWD='D:/Academic/Computer Organization and Digital Design/Labs/Lab7/Lab7/Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AU_7_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AU_7_seg.tcl -notrace
