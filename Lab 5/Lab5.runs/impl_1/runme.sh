...
HD_PWD='D:/Academic/Computer Organization and Digital Design/Labs/Lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Slow_Clk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Slow_Clk.tcl -notrace
